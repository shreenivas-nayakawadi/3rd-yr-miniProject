...
// 			className='max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden mx-4 sm:mx-auto'
// 		>
...
// 						<Link to='/forgot-password' className='text-gray-800 text-sm sm:text-base hover:underline'>
// 							Forgot password?
// 						</Link>
// 					</div>
// 					{error && <p className='text-red-500 font-semibold text-sm sm:text-base mb-2'>{error}</p>}
...
// 						disabled={isLoading}
// 					>
// 						{isLoading ? <Loader className='w-5 sm:w-6 h-5 sm:h-6 animate-spin mx-auto' /> : "Login"}
// 					</motion.button>
// 				</form>
// 			</div>
